...
$$\vec{g}(\vec{r}_{\text{observer}},t) = -\sum_{i\in \mathcal{P}}\frac{GM_i}{\left|\vec r_{\text{ovserver}}(t)-\vec r_i(t)\right|^2}\cdot\frc{\vec r_{\text{observer}}(t)-\vec r_i(t)}{\left|]vec r_{\text{observer}}(t)-\vec r_i(t)\right|}$$
